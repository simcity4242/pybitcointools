...
def bip39_hex_to_mn(hexstr, lang=None):
    ...
    BIP39 = BIP39LIST if not lang else lang
    ...
    return " ".join([BIP39[int(x, 2)] for x in
...
def bip39_check(mnemonic, lang=None):
...
def random_bip39_pair(bits=128, lang=None):
    ...
    return hexseed, bip39_hex_to_mn(hexseed, lang)
